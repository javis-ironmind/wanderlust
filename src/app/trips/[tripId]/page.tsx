...
import { Plus, Calendar, MapPin, Clock, ChevronLeft, Plane, Building2 } from 'lucide-react';
...
export default function TripDetailPage() {
  ...
  // Demo: Add sample days if trip has none
  useEffect(() => {
    if (trip.days.length === 0) {
      // Trip has no days yet - would need to add via store actions
      console.log('No days in trip');
    }
  }, [trip]);
